...
public class InventoryDatabase {
	String orgId;
	HashMap<String, ArrayList<InventoryItem>> theDatabase = new HashMap<String, ArrayList<InventoryItem>>();
	HashMap<String, ArrayList<InventoryItem>> updatedItems = new HashMap<String, ArrayList<InventoryItem>>();
